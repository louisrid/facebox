...
const PHOTO_BODY_FIGURE: Record<string, Record<string, string>> = {
  slim: {
    regular: "Slim toned figure with C-D cup breasts, noticeable chest, natural cleavage, narrow waist, narrow hips, toned slim arms, flat toned stomach, fit figure",
  ...
  regular: {
    regular: "Hourglass figure with C-D cup breasts, noticeable chest, natural cleavage, defined waist, feminine hips, toned slim arms, flat toned stomach, fit figure",
  ...
  curvy: {
    regular: "Curvaceous hourglass figure with C-D cup breasts, noticeable chest, natural cleavage, narrow waist, wide hips, toned slim arms, flat toned stomach, fit figure",
...
const BUST_SIZE_MAP: Record<string, string> = {
  regular: "C-D cup breasts, noticeable chest, natural cleavage",
