  ...
  if (authLoading && !hasCachedUser) {
    return (
      <div className="relative min-h-screen overflow-hidden">
        <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[34px] pb-[160px] flex flex-col items-center">
      ...
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[34px] pb-[160px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-2.5 self-center">
          ...
          >
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-white shrink-0">
        ...
        {user?.email === "louisjridland@gmail.com" && (
          <button
            ...
            style={{ color: "hsl(var(--neon-green))", backgroundColor: "#031a08", border: "2px solid hsl(var(--neon-green))", borderRadius: 8 }}
          >
...
const SignInView = ({ signIn, signUp, redirectTo }: { signIn: (e: string, p: string) => Promise<void>; signUp: (e: string, p: string) => Promise<void>; redirectTo?: string | null }) => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[34px] pb-[160px] flex flex-col items-center">
        <div className="flex items-center gap-[14px] mb-12 w-full">
          <BackButton always />
          <PageTitle className="mb-0">settings</PageTitle>
        </div>
