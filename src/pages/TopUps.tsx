...
import { Gem, ShoppingCart, Gift, Sparkles } from "@/lib/icons";
...
const TopUps = () => {
  ...
  if (!loading && !user) return (
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative z-[1] w-full max-w-lg mx-auto px-[24px] pt-[34px] pb-[160px]">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      disabled={claiming}
                      className="flex items-center gap-2 rounded-[8px] px-5 py-3 text-sm font-[900] lowercase transition-all disabled:opacity-60"
          ...
          {packs.map((pack) => (
            ...
            >
              ...
              <div className="flex-1 flex flex-col relative z-[1]">
                ...
                {pack.badge && (
                  <div className="mt-2">
                    <span className="inline-block rounded-[8px] px-3 py-1 text-[10px] font-[900] lowercase bg-neon-yellow text-neon-yellow-foreground">
                      {pack.badge}
                    </span>
                  </div>
                )}
              ...
              >
                ...
                <span
                  className="cart-btn rounded-[8px] px-5 py-3 bg-neon-yellow text-neon-yellow-foreground flex items-center justify-center"
                >
