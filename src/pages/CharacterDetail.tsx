...
import { Loader2, Trash2, Lock, RefreshCw, Gem, Check } from "@/lib/icons";
  ...
  if (loading || (authLoading && !hasCachedUser)) {
    return (
      <div className="relative min-h-screen overflow-hidden">
        <main className="relative z-[1] mx-auto w-full max-w-lg md:max-w-3xl px-[24px] md:px-[48px] pt-[34px] pb-[160px]">
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-7 pb-4 md:hidden" style={{ minHeight: "100dvh", overflow: "hidden" }}>
        <div className="flex items-center gap-[14px] mb-12" style={{ position: "relative", zIndex: 10 }}>
          {onboardingComplete ? <BackButton /> : (
            <button
              ...
              aria-label="go back"
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="md:w-[16px] md:h-[16px]">
...
<button onClick={() => setShowDelete(true)} className="active:scale-95 transition-transform">
          ...
          <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8 }} className="px-3 py-2">
            <div className="grid grid-cols-4 gap-1">
              {traits.map((t) => (
                <div key={t.label} className="rounded-[8px] py-2 text-center" style={{ backgroundColor: "hsl(var(--card))" }}>
                  ...
                  <span className={`inline-block font-[800] text-white leading-none text-[10px] border-[2px] border-[hsl(var(--border-mid))] rounded-[8px] ${t.value === "XL" ? "normal-case" : "lowercase"}`} style={{ backgroundColor: "hsl(var(--card))", padding: "4px 8px" }}>{t.value}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex items-center gap-[14px] mb-12">
          {onboardingComplete ? <BackButton /> : (
            <button
              ...
              aria-label="go back"
            >
              <svg width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <line x1="12" y1="7" x2="2" y2="7" />
                <polyline points="7,2 2,7 7,12" />
              </svg>
            </button>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-7">
            ...
            {latestPhotos.length > 0 && (
              <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8 }} className="p-5 mt-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {Array.from({ length: 6 }).map((_, i) => {
                    ...
                    return (
                      ...
                      >
                        {photo && (
                          <img src={photo.url} alt="" className="h-full w-full absolute inset-0" style={{ objectFit: "cover", borderRadius: 8 }} />
                        )}
                      </div>
                    );
                  })}
            ...
            <div style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8 }} className="p-5">
              <h3 className="text-sm font-[900] lowercase text-white mb-3">traits</h3>
               <div className="grid grid-cols-2 gap-2">
                {traits.map((t) => (
                  <div key={t.label} className="rounded-[8px] px-3 py-2 text-center" style={{ backgroundColor: "hsl(var(--card))", border: "2px solid hsl(var(--border-mid))" }}>
        ...
        {showDelete && (
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: "hsl(var(--card))", borderRadius: 8, border: "2px solid hsl(var(--border-mid))", padding: "28px 24px 24px" }}
            >
              ...
              <p className="text-sm md:text-base font-[900] lowercase mb-6 text-center text-white">
              ...
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  style={{ backgroundColor: "#1a0505", borderRadius: 8, border: "2px solid #ff4444", color: "#ff4444" }}
                >
