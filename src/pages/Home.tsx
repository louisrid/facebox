...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const dataReady = cachedCharsLoaded && generationsReady;
    if (!dataReady) {
      // Hold the blocker — keep it until data loads
      unblockRef.current = unblockRef.current || early || registerBlockingLoader();
      return;
    }

    if (expectedImageCount === 0) {
      // Data loaded, no images — release
    ...
    // Data loaded, images expected — keep blocker until images load
    if (!unblockRef.current) {
      unblockRef.current = early || registerBlockingLoader();
    }

    // Fast-path: if all images are already in the DOM and browser-cached, unblock immediately
  ...
  return (
    <div className="relative min-h-[calc(100dvh-90px)] overflow-hidden">
      ...
      {!pageHidden && <div className="relative flex h-full flex-col">
        ...
        <main className="relative z-[1] mx-auto w-full max-w-lg px-[24px] pt-[75px] pb-[160px] md:hidden">
          ...
          <div className="flex gap-2 mb-3 mt-[20px]">
            ...
            >
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            >
              ...
              <svg className="relative z-[1]" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      else if (!user) navigate("/auth?redirect=/");
                      else if (isFirstPlaceholder) navigate("/create");
                    }}
                  ...
                  >
                    <AspectRatio ratio={3 / 4}>
                      {isPlaceholder ? (
                        isFirstPlaceholder ? (
                          <div className="flex h-full w-full items-center justify-center text-white"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div>
                        ) : (
                          <div className="h-full w-full" />
                        )
                      ) : (
                        <img src={photo.url} alt="latest photo" data-home-image="1" className="h-full w-full object-cover" loading="eager" decoding="sync" onLoad={handleImageLoaded} onError={handleImageLoaded} />
                      )}
                    </AspectRatio>
                  </button>
                );
        ...
        {/* Desktop layout */}
        <main className="hidden md:block relative z-[1] w-full max-w-3xl mx-auto px-[44px] pt-[69px] pb-[160px]">
          ...
          {/* <div className="mt-6 mb-12" style={{ width: 60, height: 8, borderRadius: 9999, backgroundColor: "#ffe603" }} /> */}
          ...
          <div className="flex gap-3 mb-8 mt-[24px]">
            ...
            >
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                <circle cx="12" cy="7" r="4" />
              </svg>
            </button>
            ...
            >
              ...
              <svg className="relative z-[1]" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
                <circle cx="12" cy="13" r="4" />
              </svg>
              {showLocks && <LockOverlay borderRadius={10} />}
                ...
                return (
                  ...
                  >
                    <AspectRatio ratio={3 / 4}>
                      {isPlaceholder ? (
                        isFirstPlaceholder ? (
                          <div className="flex h-full w-full items-center justify-center text-white"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div>
                        ) : (
                          <div className="h-full w-full" />
                        )
                      ) : (
