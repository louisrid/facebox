...
const IntroNavArrow = ({
  ...
  <button
    ...
    style={{
      ...
      borderRadius: 8, outline: "none", padding: 0,
        ...
        >
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-h-0">
              ...
              <div className="flex-1 flex justify-center px-8 min-h-0 overflow-hidden">
                <div className="mx-auto flex w-full max-w-xs flex-col items-center justify-center" style={{ paddingTop: 168, paddingBottom: 0 }}>
